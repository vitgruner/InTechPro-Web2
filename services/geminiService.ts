...
export const getVisionaryResponse = async (userPrompt: string) => {
  ...
  try {
    ...
    return response.text || "Omlouvám se, moje analýza nebyla dokončena. Zkuste prosím dotaz přeformulovat.";
  } catch (error: any) {
