...
const ProjectionVisualizer = () => {
  ...
  const layers = [
    ...
    { id: 'sensors', label: 'Senzorika', icon: Eye, color: '#69C350', bg: 'bg-[#69C350]' },
              ...
              >
                <rect 
                  ...
                  className={`transition-all duration-500 fill-white dark:fill-[#1a1d21] stroke-slate-300 dark:stroke-white/10 ${
                    hoveredRoom === room.name ? 'stroke-[#7BD462]/50 stroke-2' : 'stroke-1'
                  }`}
                  rx="4"
                />
                <rect 
                  ...
                  className={`transition-all duration-500 pointer-events-none ${
                    hoveredRoom === room.name ? 'fill-[#69C350]/5' : 'fill-transparent'
                  }`}
                  rx="4"
                />
                <text 
                  ...
                  className={`text-[9px] font-black uppercase tracking-widest transition-colors pointer-events-none ${
                    hoveredRoom === room.name ? 'fill-[#69C350] dark:fill-[#95E87D]' : 'fill-slate-400 dark:fill-gray-600'
                  }`}
                >
                  {room.name}
                </text>
